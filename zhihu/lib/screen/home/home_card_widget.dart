                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [Text("三七二十",style: TextStyle(fontSize: 14),)],
                        ),
                        Text("12小时前·赞同了该回答",style: TextStyle(fontSize: 12),)
                      ],
                    ),
                  ),
                ],
